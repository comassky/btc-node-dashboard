<template>
  <BaseCard status="success" interactive>
    <div class="flex items-center justify-between">
      <div class="text-2xl text-accent sm:text-3xl">
        <font-awesome-icon :icon="['fas', 'hard-hat']" />
      </div>
      <div class="text-xs font-medium uppercase text-text-secondary">Node Details</div>
    </div>
    <div
    ...
    >
      ...
      <div class="flex w-full flex-col items-end sm:w-auto">
        ...
        <div class="text-xs text-text-secondary sm:text-sm">Uptime</div>
      </div>
    </div>
    <div
      class="mt-2 border-t border-border-strong pt-2 text-xs text-text-secondary sm:mt-3 sm:pt-3 sm:text-sm"
    >
            ...
            >
              <p class="flex items-center gap-1">
                <span class="inline-flex h-5 w-5 items-center justify-center">
                  <font-awesome-icon :icon="['fas', 'hdd']" class="text-base text-text-secondary" />
                </span>
