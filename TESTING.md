...
| Frontend  | 83    | Vitest (4.0.18), Vue Test Utils (2.4.6), Happy DOM (20.0.11), Vite (7.3.1), TypeScript (5.9.3), VueUse (14.2.1), Chart.js (4.5.1), Tailwind CSS (4.1.18), Iconify (5.0.0), Simple Icons (1.2.70), Floating UI (1.1.10) |
